...
public class RoleService {
     ...
     * 获取所有的角色信息 (分页加模糊查询)
     */
    public List<Map<String, Object>> findAllRoleInfo(String pageNum, String pageSize, String roleNameCN) {
        ...
        for (Map<String, Object> roleInfo : allRoleInfo) {
            ...
            List<Map<String, Object>> notRootMenuInfoByRoleId = authorityUserRepository.findNotRootMenuInfoByRoleId(roleId);
            notRootMenuInfoByRoleId.forEach(rootMenuInfo -> {
                Map<String, Object> map = new HashMap<>();
